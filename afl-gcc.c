...
/* [analysis] 2. find_as在AFL_PATH中查找可用as，或者在afl-gcc目录中查找可用afl-as
*/
...
static void edit_params(u32 argc, char** argv) {
  ...
  /* [analysis] 3. 如果程序名前9字符为"afl-clang"，则设置clang-mode=1
  */
  if (!strncmp(name, "afl-clang", 9)) {
	...
	*/
	...
	/* [analysis] 5. 非clang-mode，依次尝试设置程序为AFL_CXX, AFL_GCJ, AFL_CC
	*/
#ifdef __APPLE__
